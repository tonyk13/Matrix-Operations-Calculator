 ...
 *
 * <p>
 * <i>Current features:</i> create, random, print, add, subtract, multiply, dot
 * product, rref, eigenvalues of 2x2
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * <i>Bugs:</i> trace for 3x3 does not work when attempting to find eigenvalues
 * beforehand, "null" is printed when
 * attempting to find eigenvalues of 3x3, addition, subtraction, and
 * multiplication don't work.
 * </p>
 *
            ...
            while (!quitProgram) {
                try {
                    ...
                    if (menuInput.equalsIgnoreCase("1")) {
                        ...
                        int matrixSizeInput =
                                Integer.parseInt(new BufferedReader(new
                                        InputStreamReader(System.in)).readLine());

                        if (matrixSizeInput == 1 || matrixSizeInput == 2 ||
                                matrixSizeInput == 3) {
                            ...
                            throw new IllegalArgumentException("User entered an" +
                                    " invalid option.");
                        }
                        ...
                        if (matrixSizeInput == 1 || matrixSizeInput == 2 ||
                            ...
                            throw new IllegalArgumentException("User entered " +
                                    "an invalid option.");
                        }
                        ...
                        //optimize this, don't repeat code
                        int i = 1;
                        for (Matrix matrix : matrices) {
                            System.out.println("\n" + i);
                            matrix.print();
                        ...
                        int matrixDeleteInput =
                                Integer.parseInt(new BufferedReader(new
                                        InputStreamReader(System.in)).readLine());

                        if (matrixDeleteInput < 1 || matrixDeleteInput > matrices
                                .size() - 1) {
                            throw new IllegalArgumentException("User entered " +
                                    "an invalid option.");
                        }
                        matrices.remove(matrixDeleteInput - 1);

                        System.out.println("\nMatrix " + matrixDeleteInput +
                                " " +
                                "removed!");
                        ...
                        if (operationInput == 1) { //Add
                            if (matrices.size() == 0) {
                                ...
                                if (firstMatrixInput < 1 || firstMatrixInput
                                        > matrices.size()) {
                                    ...
                                    if (secondMatrixInput < 1 || secondMatrixInput
                                            > matrices.size()) {
                                        throw new IllegalArgumentException
                                                ("Matrix doesn't exist.");
                                    } else { //add the matrices
                                        matrices.add(matrices.get
                                                (firstMatrixInput - 1).add(matrices
                                                .get(secondMatrixInput - 1)));
                                        System.out.println("\nSum: ");
                                        matrices.get(matrices.size() - 1).print();
                                        ...
                                        System.out.println("3) Maybe"); //use Math
                                        // .Random to generate an answer
                            ...
                            if (matrices.size() == 0) {
                                ...
                                if (firstMatrixInput < 1 || firstMatrixInput
                                    ...
                                    if (secondMatrixInput < 1 || secondMatrixInput
                                        ...
                                        matrices.add(matrices.get(firstMatrixInput - 1)
                                                .subtract(matrices
                                                        .get(secondMatrixInput - 1)));
                                        System.out.println("\nDifference: ");
                                        matrices.get(matrices.size() - 1).print();
                            ...
                            if (matrices.size() == 0) {
                                ...
                                if (matrixInput < 1 || matrixInput > matrices.size()) {
                                    ...
                                    System.out.println("Do you want to save the " +
                                    ...
                                    if (saveRrefInput == 1) {
                                        ...
                                        if (random == 1) {
                                            System.out.println("Reduced row " +
                                                    "echelon form saved!");
                                            return;
                                        } else if (random == 2) {
                                            matrices.remove(matrices.size() - 1);
                            ...
                            //I would like to thank Ben Wu for being a
                            // phenomenal TA in MAT 211 Fall 2020
                            ...
                            if (matrices.size() == 0) {
                                ...
                                if (matrixInput < 1 || matrixInput > matrices.size()) {
                                    throw new IllegalArgumentException("Matrix " +
                                            "doesn't exist.");
                                } else if (matrices.get(matrixInput - 1)
                                        .getNumRows() != 2 && matrices.get
                                        (matrixInput - 1).getNumCols() != 2) {
                                    throw new IncompatibleMatricesException();
                                } else {
                                    //find the eigenvalues
                                    ArrayList<Double> eigenvalues = matrices
                                            .get(matrixInput - 1).eigenvalues();
                                    System.out.println("\nEigenvalues: ");
                        ...
                        } else if (operationInput == 6) { //Determinant
                            if (matrices.size() == 0) {
                                throw new NoMatricesException();
                            } else {
                                double m;
                                ...
                                if (matrixInput < 1 || matrixInput > matrices
                                        .size()) {
                                    throw new IllegalArgumentException("Matrix" +
                                            " doesn't exist.");
                                } else {
                                    ...
                                    m = Matrix.determinant
                                            (matrices.get(matrixInput - 1).matrix,
                                                    (int) matrices.get(matrixInput - 1)
                                                            .getNumRows());
                                }
                    ...
                    } else if (menuInput.equalsIgnoreCase("6")) {
                        //Quit program
                ...
                } catch (IllegalArgumentException | NoMatricesException |
